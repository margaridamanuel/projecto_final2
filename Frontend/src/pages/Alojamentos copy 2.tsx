        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-5 h-[650px]">
          ...
          <div className="relative rounded-3xl overflow-hidden group">
            ...
            <div className="absolute bottom-5 left-5 text-white">
              <h3 className="text-2xl font-bold">{alojamentos[1]?.nome}</h3>
            </div>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden group">
            ...
            <div className="absolute bottom-5 left-5 text-white">
              <h3 className="text-2xl font-bold"> {alojamentos[2]?.nome}</h3>
            </div>
          </div>

          <div className="col-span-2 relative rounded-3xl overflow-hidden group">
            <img
              src={alojamentos[3]?.imagem}
              className="w-full h-full object-cover group-hover:scale-110 transition duration-500"
            />
            ...
            <div className="absolute bottom-6 left-6 text-white">
              <h3 className="text-3xl font-bold">{alojamentos[3]?.nome}</h3>
            </div>
          </div>
        </div>
      </section>
